...
bridgeIPESQuery <- "SELECT BRIDGE_LOG.BRIDGE_LOG_ID,
  ...
  BRIDGE_LOG.AVG_GEAR_DEPTH, BRIDGE_LOG.AVG_TOW_DEPTH, 
  BRIDGE_LOG.DISTANCE_TRAVELLED, BRIDGE_LOG.USABILITY_CODE, BRIDGE_LOG.COMMENTS
FROM BRIDGE_LOG
...
chinIPESQuery <- "SELECT CATCH.CATCH_ID, CATCH.CATCH_FIELD_ID, 
  CATCH.BRIDGE_LOG_ID, CATCH.SPECIES_CODE, CATCH.CATCH_COUNT, 
  CATCH.JUVENILE_CATCH_COUNT, CATCH.CATCH_WEIGHT, CATCH.JUVENILE_CATCH_WEIGHT, 
  CATCH.COMMENTS
FROM CATCH
